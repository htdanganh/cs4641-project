...
![Linear Regression Results](/assets/linear_regression.png)
![Ridge Regression Results](/assets/ridge_regression.png)

The correlation matrix below reveals that there are a couple correlations among the features.
![Correlation Matrix Results](/assets/correlation_matrix.png)
