...
![Linear Regression Results](/assets/images/linear_regression.png)

![Ridge Regression Results](/assets/images/ridge_regression.png)

The correlation matrix below reveals that there are a couple correlations among the features.

![Correlation Matrix Results](/assets/images/correlation_matrix.png)
