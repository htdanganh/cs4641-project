...
![Linear Regression Results](/_site/assets/linear_regression.png)
![Ridge Regression Results](/_site/assets/ridge_regression.png)

The correlation matrix below reveals that there are a couple correlations among the features.
![Correlation Matrix Results](/_site/assets/correlation_matrix.png)
