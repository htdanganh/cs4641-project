...
![Linear Regression Results](_site/assets/images/linear_regression.png)

![Ridge Regression Results](_site/assets/images/ridge_regression.png)

The correlation matrix below reveals that there are a couple correlations among the features.

![Correlation Matrix Results](_site/assets/images/correlation_matrix.png)
